<template>
  ...
  <el-header style="font-size: 12px;background-color:#545c64;border-radius: 12px;">
    <el-row type="flex" justify="space-between">
      <el-col :span="10" style="font-size: 20px;color: #ffd04b">考勤管理系统</el-col>
    ...
    <el-menu 
      ...
      >
        ...
        <el-submenu index="4">
          ...
          <el-menu-item index="/employer/AddEmployer" :disabled="isrenshi">添加职工</el-menu-item>
          <el-menu-item index="/employer/AllEmployeState" :disabled="isrenshi">职工状态</el-menu-item>
          <el-menu-item index="/employer/EmployerInfo" :disabled="isrenshi">职工详情</el-menu-item>
